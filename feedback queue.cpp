...
int main()
{
	...
	for (int i = 0; i<myProcess.numberOfProcesses; i++)
	{
		for (int k = myProcess.total_exection_time; k >= 0; k--)
		{
			...
			{
				myProcess.input[i].Finish_time = k+1;
				break;
	...
	for (int i = 0; i<myProcess.numberOfProcesses; i++)
	{
		myProcess.input[i].Response_Time = myProcess.input[i].Start_Time - myProcess.input[i].Arrival_time;
		myProcess.input[i].Waiting_Time = (myProcess.input[i].Finish_time - myProcess.input[i].Arrival_time) - myProcess.input[i].Burst_time;
